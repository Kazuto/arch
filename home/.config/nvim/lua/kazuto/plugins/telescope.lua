...
return {
	...
	config = function()
		...
		-- All telescope bindings use leader for consistency (no conflicts, better discoverability)
		...
		vim.keymap.set("n", "<leader>fg", require("kazuto.plugins.telescope.multigrep"), { desc = "[F]ind [G]rep" })
		vim.keymap.set("n", "<leader>fc", builtin.grep_string, { desc = "[F]ind [C]ursor" })
		vim.keymap.set("n", "<leader>ft", "<cmd>TodoTelescope<cr>", { desc = "[F]ind [T]odos" })
		vim.keymap.set("n", "<leader>fr", builtin.resume, { desc = "[F]ind [R]esume" })
		vim.keymap.set("n", "<leader>fk", builtin.keymaps, { desc = "[F]ind [K]eymaps" })
		vim.keymap.set("n", "<leader>fx", builtin.commands, { desc = "[F]ind E[x]ecute Command" })
